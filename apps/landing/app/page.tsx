    ...
    <AppFrame eyebrow="Platform bisnis" title="Satu Altora. Produk yang fokus." version={getProduct("landing").version}>
      ...
      <section aria-labelledby="produk-title">
        ...
        <div className="product-grid">
          <ProductCard href={cafe.host} name={cafe.name} version={cafe.version}>POS dan operasional untuk kedai, restoran, dan bisnis F&B.</ProductCard>
      ...
      <section className="note" aria-labelledby="cara-kerja-title">
        ...
        <p>Altora Cafe dan Altora Market rilis secara mandiri. Nomor versi di setiap aplikasi menunjukkan perubahan yang sudah diuji pada produk tersebut.</p>
      </section>
    </AppFrame>
  );
}
