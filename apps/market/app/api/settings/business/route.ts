...
/** Simpan pengaturan bisnis (pajak, footer struk, QRIS statis). */
export async function POST(request: Request) {
  ...
  // Kosongkan QRIS = hapus; isi = validasi dulu (hex + CRC16)
  ...
  await db.query(
    `UPDATE "TenantSetting" SET "taxPercent" = $2, "receiptFooter" = $3, "staticQrisPayload" = $4, "updatedAt" = NOW() WHERE "tenantId" = $1`,
